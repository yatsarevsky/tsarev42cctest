...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vcard_entrylog', (
            ...
            ('action', self.gf('django.db.models.fields.CharField')(default='0', max_length=1)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 14, 0, 0))),
        ))
    ...
    models = {
        ...
        'vcard.entrylog': {
            ...
            'action': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '1'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 14, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
